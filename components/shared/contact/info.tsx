    ...
    <div className="bg-primary text-white rounded-3xl w-full lg:w-1/2 p-8 md:p-12 flex flex-col">
      ...
      <div className="space-y-6">
        <div className="flex flex-col font-light space-y-6">
          ...
          <div className="flex flex-col">
            ...
            <span className="font-light text-lg">info@nancompany.com</span>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col space-y-1">
              <span className="text-lg">Monday - Friday: 8:00 AM - 5:00 PM</span>
              <span className="text-lg">Saturday: 8:00 AM - 2:00 PM</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-10 text-white/90 text-lg leading-relaxed">
        <p>
          ...
          institution, we're here to support your business with reliable
          distribution services and quality products.
        </p>
      </div>
    </div>
  );
